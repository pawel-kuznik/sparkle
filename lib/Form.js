...
const toCheckbox    = require('./form/toCheckbox.js');
...
module.exports = class extends Component {
    ...
    fill(newData) {
        ...
        for (let input of inputs) {
            ...
            // if we are dealing with a checkbox that has no value then we treat
            // it like a flag. We only set the checked property.
            else if (input.getAttribute('type') == 'checkbox') toCheckbox(input, value);

            // we are dealing with a text or text-like value
            else {

...
const formToJSON = require('sparkle').formToJSON;
const fillForm = require('sparkle').fillForm;
...
module.exports = class extends Component {
    ...
    constructor(inits = { }) {
        ...
        this.elem.addEventListener('submit', event => {
            ...
            this.triggerer.triggerEvent('submit');

...
const triggerer = Symbol('triggerer');
...
module.exports = class extends EventHandlers.Emitter {
    ...
    constructor(inits = { }) {
        ...
        /**
         *  The event triggerer.
         *  @var EventEmitter.Triggerer
         */
        this[triggerer] = new EventHandlers.Triggerer(this);
    ...
    /**
     *  Get the promise on when the component is ready.
     *  @return Promise
     */
    ready() {
